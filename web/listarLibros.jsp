<%-- 
    ...
    Created on : 19 nov. 2021, 00:48:55
    Author     : HP
--%>
...
<html lang="es">
	<head>
		...
		<meta name="description" content="DFM, DPA, SASE, MSRB, RDCG" />
											...
											<table id="dynamic-table" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													...
													<tr>
														...
														<td><%= l.getAnio_publica() %></td>
                                                                                                                <td><span class="label label-sm label-success"><%= EditorialDAO.getEditorial(l.getRfc_editorial())%></span></td>
                                                                                                                <td>

<%-- 
    ...
    Created on : 19 nov. 2021, 03:06:12
    Author     : HP
--%>
							...
							<div class="col-xs-12">
								...
								<div class="row">
									<div class="col-xs-12">
										...
										<!-- div.dataTables_borderWrap FORMMMMM-->
										<div>
                                                                                    <form action="LibroControl" method="post" class="form-horizontal">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="publicacion" value="" placeholder="2021/11/19"/>
                                                                                            </div>
                                                                                        </div>
                                                                                        <!-- CATEGORIA -->
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <select name="editorial">
                                                                                                    ...
                                                                                                    <% for(Editorial edit:EditorialDAO.listar()){ %>
                                                                                                        <option value="<%= edit.getRfc()%>"><%= edit.getNombre()%></option>
                                                                                                    <%}%>
                                                                                                </select>
                                                                                            </div>                                                                                            
                                                                                        </div>
